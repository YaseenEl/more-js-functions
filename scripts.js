...
function scoreBasket(){
    return score += 2; // same as score = score + 2;
}
...
console.log('number initiated: ', number);
...
addToPage("doubleMyNumberArrow(25) = " + doubleMyNumber(25));
...
function calcChange(amount){
    ...
    // calculate the number of nickels, subtract from total
